...
class InvoiceHeaderEntidadFinanciera extends InvoiceHeader
{
	...
	public function checkAmounts()
	{
		...
		$this->montoTotal 			+= (float)$this->montoTotalArrendamientoFinanciero;
		$this->montoTotalMoneda 	= $this->montoTotal * $this->tipoCambio;
		//$this->montoTotalSujetoIva	= sb_number_format($montoTotal - $facturaSiat->cabecera->montoGiftCard, 2, '.', '');
		$montoSujetoIva				= $this->montoTotal - (float)$this->montoTotalArrendamientoFinanciero;
		$this->montoTotalSujetoIva	= sb_number_format($montoSujetoIva, 2, '.', '');
	}
}